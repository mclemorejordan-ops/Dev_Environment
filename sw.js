...
const APP_SHELL = ["./", "./index.html", "./assets/styles.css", "./src/app.js"];
...
self.addEventListener("fetch", (event) => {
  ...
  // Cache-first for all other same-origin GET requests (CSS/JS/icons/data)
  ...
  event.respondWith((async () => {
    ...
    try {
      ...
      if (fresh && fresh.ok) {
        // Opportunistic caching (never cache version.json; guarded above)
